...
/* $Header: /project/cs/aiken/aa/projects/SourceRepository/cool/cool/spim/sym-tbl.c,v 1.4 2003/04/27 19:45:06 matth Exp $
*/
...
#endif
{
  ...
  for (i = 0; i < LABEL_HASH_TABLE_SIZE; i ++)
	...
	buffer[string_length] = '\0'; /* Changed for COOL */
      }
