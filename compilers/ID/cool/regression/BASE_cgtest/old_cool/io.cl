...
class A is
   ...
   out_a() : Object is io.out_string("A: Hello world\n") end;
...
class B inherits A is
   ...
   out_b() : Object is io.out_string("B: Hello world\n") end;
...
class C inherits IO is
   ...
   out_c() : Object is out_string("C: Hello world\n") end;
...
class D inherits C is
   ...
   out_d() : Object is out_string("D: Hello world\n") end;
