...
#ifndef __MDHTBASEAPP_H_
#define __MDHTBASEAPP_H_
 ...
 * @author Bernhard Heep
 */
class MDHTBaseApp : public INotifiable, public MDHTBaseRpc
{
...
private:
     ...
     *
     * This method gets called from MDHTBaseApp::handleMessage
