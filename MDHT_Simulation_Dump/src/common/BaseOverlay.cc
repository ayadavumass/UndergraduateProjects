...
#include <GlobalBootstrapListAccess.h>
...
void BaseOverlay::initialize(int stage)
{
    if (stage == MIN_STAGE_OVERLAY) {
        ...
        globalBootstrapList = GlobalBootstrapListAccess().get();
...
cGate* BaseOverlay::getCompRpcGate(CompType compType)
{
    ...
    if (it != compModuleList.end())
        ...
        for (it = compModuleList.begin(); it != compModuleList.end(); it++)
