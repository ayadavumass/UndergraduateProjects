...
double DhtDumpEntry::getEndTime() const
{
    return endTime_var;
}

void DhtDumpEntry::setEndTime(double endTime_var)
{
...
int DhtDumpEntryDescriptor::findField(void *object, const char *fieldName) const
{
    ...
    if (fieldName[0]=='e' && strcmp(fieldName, "endTime")==0) return base+5;
    if (fieldName[0]=='o' && strcmp(fieldName, "ownerNode")==0) return base+6;
    if (fieldName[0]=='i' && strcmp(fieldName, "is_modifiable")==0) return base+7;
    if (fieldName[0]=='r' && strcmp(fieldName, "responsible")==0) return base+8;
    return basedesc ? basedesc->findField(object, fieldName) : -1;
}
...
std::string DhtDumpEntryDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 5: return double2string(pp->getEndTime());
        case 6: {std::stringstream out; out << pp->getOwnerNode(); return out.str();}
        case 7: return bool2string(pp->getIs_modifiable());
        case 8: return bool2string(pp->getResponsible());
        default: return "";
    }
}
...
bool DhtDumpEntryDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 5: pp->setEndTime(string2double(value)); return true;
        case 7: pp->setIs_modifiable(string2bool(value)); return true;
        case 8: pp->setResponsible(string2bool(value)); return true;
        default: return false;
    }
}
...
void *DhtDumpEntryDescriptor::getFieldStructPointer(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 6: return (void *)(&pp->getOwnerNode()); break;
        default: return NULL;
    }
}
