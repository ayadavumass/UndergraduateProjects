...
public:
   ...
   const TransportAddress getBootstrapNode(int level, const std::string& segment);
   ...
   void locateBootstrapNode(const NodeHandle& node);
     ...
     */
    void removeBootstrapCandidate(const TransportAddress &addr, int level = 0, const std::string& segment = "");
