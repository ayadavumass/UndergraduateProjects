 ...
 * @author Ingmar Baumgart
 */
class ClientNode : public MDHTBaseApp
{
private:
    /**
     * A container used by the ClientNode to
    ...
    int numberOfGetRequests; // Number of sites requested
    int numberOfInlineObjects; // number of inlineobjects per site
    int numberOfInitialPuts;
    bool firstGet;
    ...
    cMessage *clientNode_put_timer, *clientNode_get_timer, *clientNode_mod_timer;
    cMessage *clientNode_get_sequence_timer, *clientNode_human_read_timer, *initial_put_timer;
