...
// n represents current depth here.
int
...
//depth returned if child pid is -1.Therefore our task is to to stop when a child is not created.when it runs out of memory.
	//printf("child pid %d\n",child_pid);
